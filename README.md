...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/qcmanybody-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/qcmanybody-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi global install qcmanybody
```
...
It is possible to list all of the versions of `qcmanybody` available on your platform:
...
```
pixi search qcmanybody --channel conda-forge
```
